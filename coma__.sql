...
INSERT INTO `Bateau` (`idBateau`, `nomBateau`, `histoire`, `anneeDebutUtilisation`, `anneeFinUtilisation`, `nationalite`, `nomModele`) VALUES
...
INSERT INTO `Pays` (`nationalite`) VALUES
('Allemagne'),
('France');
