<div class="w-100">
    ...
    <div class="content-popup">
        <form action="?controller=user&action=created" method="post">
            <div class="mb-3">
                <label for="lastname" class="form-label">Nom&nbsp;:</label>
                <input id="lastname" name="nom" class="form-control" type="text"
            ...
            <div class="mb-3">
                ...
                <input id="mm" name="adresseEmail" class="form-control" type="email" placeholder="Entrer votre mail"
                       required>
                <p class="error"><?php echo (isset($errorAdresseEmail)) ? $errorAdresseEmail : ""; ?></p>
            </div>
            <div class="mb-3">
                <label for="pass" class="form-label">Mot de passe&nbsp;:</label>
                <input id="pass" name="motDePasse" class="form-control" type="password"
                       placeholder="Entrer le mot de passe"
                       required>
                <label for="pass2" class="form-label"></label>
                <input id="pass2" name="motDePasseConfirmation" class="form-control" type="password"
    ...
    <div class="d-flex justify-content-center mb-3 mt-3">
        <a href="?controller=user&action=login">Déjà inscrit&nbsp;?</a>
    </div>
</div>